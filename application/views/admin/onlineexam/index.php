                                    ...
                                    <tbody>
                                        ...
                                        foreach ($questionList as $subject_key => $subject_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"> <?php echo $subject_value->exam_from; ?> </td>

                                                <td class="mailbox-name"> <?php echo $subject_value->exam_to; ?> </td>
            ...
            <form action="<?php echo site_url('admin/onlineexam/add'); ?>" method="POST" id="formsubject">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label for="subject_id"><?php echo $this->lang->line('class') ?></label><small class="req"> *</small>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control timepicker" id="exam_from" name="exam_from">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control timepicker" id="exam_to" name="exam_to">
                                <span class="text text-danger exam_to_error"></span>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="duration"><?php echo $this->lang->line('exam') . " " . $this->lang->line('date') ?></label>
                                <input type="text" class="form-control date" id="duration" name="duration">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="class_box" id="class_box" style="display: inline-block;">
                                <option value=""><?php echo $this->lang->line('class') ?></option>
                                <?php
                                foreach ($classlist as $class_key => $class_value) {
                                    ?>
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status) {
                        ...
                        var newDate_exam_from = data.result.exam_from;
                        var date_exam_to = new Date(data.result.exam_to);
                        var newDate_exam_to = data.result.exam_to;

                        $('#duration').val(data.result.duration);
                        $('#passing_percentage').val(data.result.passing_percentage);
                        $('#exam_to').val(newDate_exam_to);
                        $('#exam_from').val(newDate_exam_from);
                        $('#exam').val(data.result.exam);
                        $('#class_id').val(data.result.class_id);
                        $('#subject_id').val(data.result.subject_id);
    ...
    function getQuestionByExam(page, exam_id) {
        ...
        var class_id = $("#class_box").val();
        var exam_name = $("#exam_name").val();
        $.ajax({
            type: "POST",
            url: base_url + 'admin/onlineexam/searchQuestionByExamID',
            data: {'page': page, 'exam_id': exam_id, 'search': search, 'class_id':class_id, 'exame_name':exam_name}, // serializes the form's elements.
            dataType: "JSON", // serializes the form's elements.
            beforeSend: function () {
                // $("[class$='_error']").html("");
                // submit_button.button('loading');

    ...
    <div class="classtopic">
        <ul class="classlist">
            ...
            <?php if ($result['lacture_video'] != '') { ?>
                ...
                <li><a data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download_video') ?>" onclick="run_local_video('<?php echo base_url() ?>admin/syllabus/lacture_video_download/<?php echo $result["lacture_video"] ?>')"><i class="fa fa-file-video-o"></i></a></li>
                <?php
            }
            ?>

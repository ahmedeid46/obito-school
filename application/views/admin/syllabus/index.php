...
<div class="modal fade syllbus" id="lacture_video_modal" role="dialog" aria-labelledby="evaluation">
    <div class="modal-dialog video-lg" role="document">
        <button type="button" class="close" data-dismiss="modal" onclick="videoBlank()">&times;</button>
        <!-- <h4 class="box-title" ><?php echo $this->lang->line('lesson') ?></h4> -->
...
<script>
    ...
    function run_local_video(lacture_local_url) {
        $('#lacture_video_modal').modal('show');
        var str = lacture_local_url;
        var res = str.split("=");
        $('#video').html('<video  oncontextmenu="return false;" autoplay controls controlsList="nodownload" style="width: 900px;height: 505px; " ><source src="'+str+'"></video>');
    }

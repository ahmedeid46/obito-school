                                ...
                                <tbody>
                                    ...
                                    foreach ($questionList as $subject_key => $subject_value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php echo readmorelink($subject_value->class_id); ?></td>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/question/add'); ?>" method="POST" id="formsubject">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exam_name">Exam name</label><small class="req"> *</small>
                        <input class="form-control" type="text" name="exam_name">
                        <span class="text text-danger exam_name_error"></span>
                    </div>
                    <div class="form-group">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status) {
                        ...
                        $('input[name=exam_name]').val(data.result.exam_name);

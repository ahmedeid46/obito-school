                    ...
                    <div class="box-body">
                        ...
                        if (!empty($online_exam_validate)) {
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo $exam->exam_from; ?></dd>

                                <dt class="col-sm-3 col-xs-4 col-md-2"><?php echo $this->lang->line('exam') . " " . $this->lang->line('to') ?></dt>
                                <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo $exam->exam_to; ?></dd>
...
<script type="text/javascript">
    ...
    function get_elapsed_time_string() {
        ...
        timer2 = timer111;
        var currentTimeString = timer111;

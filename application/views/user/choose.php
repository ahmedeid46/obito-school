                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-md-offset-3">
                        <div class="loginbg loginradius login390 bgoffsetbgno"> 
                            ...
                            if (!empty($student_lists)) {
                                ?>
                                <form id="my-form" action="<?php echo site_url('user/user/choose'); ?>" method="POST" >
                                    ...
                                    <div class="selectform">
                                        ...
                                        foreach ($student_lists as $student_key => $student_value) {
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="hidden" value="<?php echo $student_value->student_session_id; ?>" class="clschg" name="clschg"><?php echo ($role == 'parent') ? $name . " " . $student_value->class . " (" . $student_value->section . ")" : $student_value->class . " (" . $student_value->section . ")"; ?>
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-bottom"><input type="submit" onload="this.click()" id="submit" class="btn2 pull-right" name="submit" value="<?php echo $this->lang->line('select_and_proceed'); ?>"></div>
                                </form>

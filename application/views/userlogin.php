                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                <div class="loginbg loginradius login390">  
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <p style="float:left;" ><a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"> <i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?></a> </p> 
                                        <p style="float:right;"><a href="<?php echo site_url('site/login') ?>" class="forgot"> <i class="fa fa-user-secret"></i> <?php echo $this->lang->line('teacher_login'); ?></a> </p> 
                                    </div>
                                </div>  
                            </div>
                            <?php

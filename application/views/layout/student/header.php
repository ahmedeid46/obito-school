...
<?php } } ?>
                        ...
                        if ($this->studentmodule_lib->hasActive('download_center')) {
                            ?>
                                    <li class="treeview <?php echo set_Topmenu('content/studymaterial'); ?>"><a href="<?php echo base_url(); ?>user/content/studymaterial"><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('study_material'); ?></a></li>

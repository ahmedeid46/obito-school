...
<?php } ?>
                                    <input type="hidden" name="guardian_is" value="father">
                                    <input id="guardian_name" name="guardian_name" placeholder="" type="hidden" class="form-control"  value="site" />
                                    <input id="guardian_relation" name="guardian_relation" placeholder="" type="hidden" class="form-control"  value="<?php echo set_value('guardian_relation'); ?>" />
                                    <input id="guardian_phone" name="guardian_phone" placeholder="" type="hidden" class="form-control"  value="3456789" />
                                    <input id="guardian_occupation" name="guardian_occupation" placeholder="" type="hidden" class="form-control"  value="234356789" />

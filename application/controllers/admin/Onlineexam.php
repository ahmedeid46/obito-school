...
class Onlineexam extends Admin_Controller {
    ...
    public function searchQuestionByExamID() {
        ...
        if (isset($page)) {
            ...
            if ( !empty($_POST['search']) and  !empty($_POST['class_id'])) {
                $search = $this->input->post('search');
                $class_id = $this->input->post('class_id');
                $and_array = array('subjects.id' => $search,"class_id"=>$class_id);
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_data = array(
                ...
                'duration' => date('Y-m-d', $this->customlib->datetostrtotime($this->input->post('duration'))),
